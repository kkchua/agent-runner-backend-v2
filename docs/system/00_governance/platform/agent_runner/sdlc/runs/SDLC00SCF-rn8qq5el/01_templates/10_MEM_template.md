...
- Document ID (e.g., MEM-20260806-001)
...
Findings from the technical_critique step and their resolutions. Each
finding includes the finding identifier, resolution action, and status.

### 8. Recommendations for Future Initiatives
...
```
MEM-20260806-001_add-user-authentication.md
```
