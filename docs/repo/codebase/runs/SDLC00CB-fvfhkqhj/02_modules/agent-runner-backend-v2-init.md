...
module_path: "agent_runner_backend_v2/__init__.py"
module_area: "package"
documentation_mode: "stub"
owner_doc_path: "docs/repo/codebase/current/02_modules/agent-runner-backend-v2-init.md"
...
Agent Runner Backend V2 -- Platform V2 with state machine.
