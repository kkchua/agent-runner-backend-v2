...
| `tests/unit/test_serializers.py` | test coverage |
...
| `tests/unit/test_serializers.py` | outbound | markdown | test coverage |
...
|------|--------|-----------------|-------------|
| 2026-08-06 | Initial baseline generated from repository scan | 12 modules/files | sdlc_00_codebase_v1 |
